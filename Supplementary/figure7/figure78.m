...
disp('###### Results of Quadratic SVM, Bagged Trees and scASK on the Ginhoux dataset with data perturbation ######')
tic;
load('MPSSC\Data_Ginhoux.mat'); in_X = 0.3*in_X;
...
[in_X_SLC,class_num,slice_tik,binary_mod] = slicematrix(in_X,true_labs,linspace(0,1.6,100));
[in_X_SLC_diff,in_X_SLC_SRCIstd,slice_bst,slice_vle] = slicediffer(in_X_SLC,slice_tik,21);
[SLC_Model_DIS1,istrain,istest] = slicemethod(in_X_SLC,true_labs,slice_tik,slice_bst,15,'correlation','inverse',5);
[SLC_Model_DIS2,istrain,istest] = slicemethod(in_X_SLC,true_labs,slice_tik,slice_bst,15,'jaccard','inverse',5);
[SLC_Model_DIS3,istrain,istest] = slicemethod(in_X_SLC,true_labs,slice_tik,slice_bst,15,'cosine','inverse',5);
...
testingData_accuracy86_rz = max(FIT1_accuracy,FIT2_accuracy);
fprintf(2,['testingData_accuracy86_rz = ',num2str(testingData_accuracy86_rz),'\n']);
close all;
...
testingData_accuracy82_rz = sum(testingData_fitlabs82 == testingData_truelabs82)/sum(istest);
fprintf(2,['testingData_accuracy82_rz = ',num2str(testingData_accuracy82_rz),'\n']);
...
testingData_accuracy85_rz = sum(testingData_fitlabs85 == testingData_truelabs85)/sum(istest);
fprintf(2,['testingData_accuracy85_rz = ',num2str(testingData_accuracy85_rz),'\n']);
clearvars -except testingData_accuracy82_rz testingData_accuracy85_rz testingData_accuracy86_rz
save figure78.mat testingData_accuracy82_rz testingData_accuracy85_rz testingData_accuracy86_rz
toc;
