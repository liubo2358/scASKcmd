...
[in_X_SLC,class_num,slice_tik,binary_mod] = slicematrix(in_X,true_labs,0:0.05:4);
...
testingData_accuracy36_rz = max(FIT1_accuracy,FIT2_accuracy);
fprintf(2,['testingData_accuracy36_rz = ',num2str(testingData_accuracy36_rz),'\n']);
close all;
...
testingData_accuracy32_rz = sum(testingData_fitlabs32 == testingData_truelabs32)/sum(istest);
fprintf(2,['testingData_accuracy32_rz = ',num2str(testingData_accuracy32_rz),'\n']);
...
testingData_accuracy35_rz = sum(testingData_fitlabs35 == testingData_truelabs35)/sum(istest);
fprintf(2,['testingData_accuracy35_rz = ',num2str(testingData_accuracy35_rz),'\n']);
clearvars -except testingData_accuracy32_rz testingData_accuracy35_rz testingData_accuracy36_rz
save figure73.mat testingData_accuracy32_rz testingData_accuracy35_rz testingData_accuracy36_rz
toc;
